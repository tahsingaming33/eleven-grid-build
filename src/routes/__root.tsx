...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://motiondude.online" },
      { property: "og:image", content: "https://motiondude.online/og-image.png" },
      ...
      { name: "twitter:image", content: "https://motiondude.online/og-image.png" },
    ],
    links: [
      {
        rel: "stylesheet",
